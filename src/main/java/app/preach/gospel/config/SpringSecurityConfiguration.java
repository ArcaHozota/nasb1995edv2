...
public class SpringSecurityConfiguration {
	 ...
	 * 除外するパス
	 */
	private static final String[] IGNORANCE_PATHS = { "/category/initial.action", "/static/**", "/home/**.action",
			"/**", "/category/loginWithError.action", "/students/preLogin.action", "/hymns/pagination",
