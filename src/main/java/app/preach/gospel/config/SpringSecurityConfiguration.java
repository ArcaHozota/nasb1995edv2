...
public class SpringSecurityConfiguration {
	 ...
	 * 除外するパス
	 */
	private static final String[] IGNORANCE_PATHS = { "/category/initial.action", "/static/**", "/toHomePage.action",
			"/homePage.action", "/home.action", "/index.action", "/toIchiranhyo.action",
